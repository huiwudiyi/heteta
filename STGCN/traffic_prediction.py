...
class GCN(nn.Module):
    ...
    def forward(self, data, device):
        ...
        # 转到 device上
        flow_x = data["flow_x"].to(device)  # [B, N, H, D]  flow_x
        #
